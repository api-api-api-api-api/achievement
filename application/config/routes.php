...
$route['data-divisi'] = 'admin/divisi';
$route['data-pengguna'] = 'admin/pengguna';
$route['tambah-pengguna'] = 'admin/tambah_pengguna';
$route['tambah-divisi'] = 'admin/tambah_divisi';

$route['DaftarAchievement'] = 'achievement/index';

$route['KegiatanDivisi'] = 'kegiatan/index';
$route['Kegiatan'] = 'kegiatan/kegiatan';

$route['laporan-achievement'] = 'laporan/laporan';
$route['laporan-achievement-kadiv'] = 'laporan/laporan_kadiv';
