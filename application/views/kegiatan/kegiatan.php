...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <!-- page heading - judul -->
            <h4 class="h4 mb-2 mt-1 text-gray-900"><i class="fa fa-fw fa-list"></i> <?= $this->session->userdata('nama'); ?></h4>

        </div>
    </div>

        <div class="card">
            <button type="button" data-toggle="modal" data-target="#tambah-data" class="btn text-white bg-gradient-primary mb-2" role="button"><i class="fas fa-fw fa-plus"></i> Tambah Data</button>
                <table id="table-kegiatan" class="table border-left-info table-striped display" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>Tanggal</th>
                            <th>Keterangan</th>                                    
...
<div class="modal fade" id="tambah-data" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?= form_open('kegiatan/tambah_data_aksi', ['id' => 'formTambahData']); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-info text-white">
                <h5 class="modal-title">Edit kegiatan</h5> <h5 class="instansi">
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('kegiatan/ubah_status'); ?>" method="post">
                <div class="modal-body">
...
<div class="modal fade" id="hapus-kegiatan" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('kegiatan/hapus_data'); ?>" method="post">
                <div class="modal-body">
    ...
    $(document).ready(function() {
        ...
        function dataTables_kegiatan() {
            $('#table-kegiatan').DataTable({
                ...
                "ajax": {
                    "url": "<?= base_url('kegiatan/read_data_user') ?>",
                    "type": "POST"
                },
