...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <h4 class="h4 mb-2 mt-1 text-gray-900"><i class="fa fa-fw fa-star"></i> Tim Pusat</h4>
            <?php else: ?>
            <h4 class="h4 mb-2 mt-1 text-gray-900"><i class="fa fa-fw fa-star"></i> <?= $this->session->userdata('nama_divisi'); ?></h4>
            <?php endif; ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="table-achievement-manager" class="table table-striped display" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Tanggal</th>                                   
...
<div class="modal fade" id="tambah-data" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?= form_open('achievement/tambah_data_aksi', ['id' => 'formTambahData']); ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-info text-white">
                <h5 class="modal-title">Detail Achievement</h5> <h5 class="instansi">
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('achievement/ubah_status'); ?>" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" id="id_achievement">
                    <div class="modal-body">
                        <div class="form-group floating-label-form-group">
                            <label readonly class="form-control-plaintext font-weight-bold tgl" name="tgl">
                        </div>

                        <div class="form-group floating-label-form-group">
                            <label for="keterangan" class="font-underline"><u>Keterangan :</u></label>
                            <textarea readonly class="form-control isi" rows="12" name="keterangan" id="keterangan"></textarea>
                        </div>
                </div>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="edit-achievement" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-info text-white">
            ...
            <form action="<?= base_url('achievement/ubah_status'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group floating-label-form-group">
                            <label for="keterangan" class="font-underline"><u>Keterangan :</u></label>
                            <textarea class="form-control isi" rows="12" name="keterangan" id="keterangan"></textarea>
                        </div>
                </div>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="detail-achievement-manager" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-gradient-info text-white">
                <h5 class="modal-title">Detail Achievement</h5> <h5 class="instansi">
...
<div class="modal fade" id="hapus-achievement" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('achievement/hapus_data'); ?>" method="post">
                <div class="modal-body">
    ...
    $(document).ready(function() {
        ...
        function dataTables_achievement() {
            $('#table-achievement').DataTable({
                ...
                "ajax": {
                    "url": "<?= base_url('achievement/read_data') ?>",
                    "type": "POST"
                },
        ...
        dataTables_achievement_manager();

        function dataTables_achievement_manager() {
            $('#table-achievement-manager').DataTable({
                responsive: true,
                "destroy": true,
                "processing": true,
                "serverSide": true,
                ...
                "ajax": {
                    "url": "<?= base_url('achievement/read_data_manager') ?>",
                    "type": "POST"
                },
        ...
        $(document).on("click", ".btn-hapus", function() {
            ...
            $(".modal-body div .divisi").html($(this).data('divisi'))
