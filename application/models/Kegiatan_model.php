...
class Kegiatan_model extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->from('kegiatan');
        $this->db->join('user', 'user_id = id_user');
        $this->db->where('kegiatan.divisi_id', $this->session->userdata('divisi'));
    ...
    private function _get_datatables_query_user()
    {
        ...
        $this->db->from('kegiatan');
        $this->db->join('user', 'user_id = id_user');
        $this->db->where('kegiatan.user_id', $this->session->userdata('id_user'));
    ...
    public function ubahStatuskegiatan()
    {
    ...
    {
        return $this->db->get_where('user', 'user.role_id != 3')->result_array();
    }

    public function getNamaUserDivisi()
    {
        return $this->db->get_where('user', 'user.divisi = '.$this->session->userdata('divisi').'')->result_array();
    }
    ...
    public function getkegiatanByDate($mulai, $selesai, $user = false, $divisi = false)
    {
